...
namespace BC
{
    namespace Web
    {
        namespace Http
        {
            ...
            public:
                DiskCache(ServiceController *con);
                ~DiskCache();
            ...
            private:
                ...
                DiskCacheItem* load(string path);
            };
        }
    }
}
