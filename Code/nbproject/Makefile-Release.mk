...
${OBJECTDIR}/CountryLookup.o: CountryLookup.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CountryLookup.o CountryLookup.cpp

${OBJECTDIR}/DiskCache.o: DiskCache.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DiskCache.o DiskCache.cpp
...
${OBJECTDIR}/HttpResponse.o: HttpResponse.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/HttpResponse.o HttpResponse.cpp

${OBJECTDIR}/IC_MCP3008.o: IC_MCP3008.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/IC_MCP3008.o IC_MCP3008.cpp

${OBJECTDIR}/IClientHandler.o: IClientHandler.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/IClientHandler.o IClientHandler.cpp

${OBJECTDIR}/PageFunctions.o: PageFunctions.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PageFunctions.o PageFunctions.cpp

${OBJECTDIR}/Pages.o: Pages.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Pages.o Pages.cpp
...
${OBJECTDIR}/RelayBoard.o: RelayBoard.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RelayBoard.o RelayBoard.cpp

${OBJECTDIR}/RelayConditionFunctions.o: RelayConditionFunctions.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RelayConditionFunctions.o RelayConditionFunctions.cpp
...
${OBJECTDIR}/ServiceController.o: ServiceController.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ServiceController.o ServiceController.cpp

${OBJECTDIR}/Templates.o: Templates.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Templates.o Templates.cpp
...
${OBJECTDIR}/WebService.o: WebService.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/WebService.o WebService.cpp
